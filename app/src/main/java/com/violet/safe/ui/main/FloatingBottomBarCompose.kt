...
import com.violet.safe.ui.animation.DampedDragAnimation
import com.violet.safe.ui.animation.InteractiveHighlight
...
fun FloatingBottomBar(
    ...
    val containerColor = if (isBlurEnabled) {
        MaterialTheme.colorScheme.surfaceContainer.copy(0.4f)
    } else {
