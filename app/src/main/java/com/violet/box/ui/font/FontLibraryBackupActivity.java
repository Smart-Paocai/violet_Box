package com.violet.box.ui.font;
...
public class FontLibraryBackupActivity extends AppCompatActivity {
    ...
    /** 与 {@link com.violet.box.ui.partition.PartitionManagerActivity} 中展示的分区枚举方式一致，下列分区名不参与字库备份 */
    ...
    /**
     * 与 {@link com.violet.box.ui.partition.PartitionManagerActivity#refreshPartitionList} 一致：ls /dev/block/by-name + readlink。
     */
