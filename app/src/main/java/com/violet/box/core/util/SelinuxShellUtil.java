...
/**
 * 与 {@link com.violet.box.ui.selinux.SelinuxManagerActivity} 一致：通过 {@code su -c} 执行命令，
...
public final class SelinuxShellUtil {
    ...
    /** 与 {@link com.violet.box.ui.selinux.SelinuxManagerActivity} 内解析逻辑一致：解析 getenforce 单行输出 */
